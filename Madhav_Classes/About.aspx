<%@ Page Title="" Language="C#" MasterPageFile="~/Master_pages/Guest.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="Madhav_Classes.About" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <header class="text-center border">
      <div class="page-header">
        <div class="fontTang fontSize3em">About Madhav Classes</div>
      </div>
    </header>
    <section class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin2">
      <!--Names-->
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border fontSizeOneHalfem">
